...
<body>
    ...
    <div class="jumbotron text-center">
        <h1 class="display-4"><b>SELAMAT DATANG DI SISPRAS</b></h1><br>
        <p class="lead">SISPRAS adalah sistem informasi sarana dan prasarana yang mencakup pengajuan perbaikan sarana dan prasarana, pengadaan barang, serta peminjaman sarana dan prasarana di sebuah instansi untuk mendukung kelancaran operasional.</p>
    </div>
    <div class="container">
        <div>
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Perlu Sesuatu Untuk Menunjang Pembelajaran? <br> Ajukan Disini Untuk Pengadaaan</p>
    ...
    <div class="text-center my-4">
        <a href="register.php" class="btn btn-success btn-lg">Tambah AKun</a>
    </div>
    ...
    <footer>
        ...
        <p>By</p>
        <p>Rizki Ibrahim</p>
        <p>Moh. Putra Ramadhan Abdullah</p>
        <p>Yusuf Caesaryo Syafrullah Ibrahim</p>
    </footer>
