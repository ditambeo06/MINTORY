...
$data = mysqli_query($db, "SELECT * FROM tb_perbaikan WHERE status = 1 ORDER BY id_perbaikan DESC");
                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <form action="daftar_permohonan.php" method="post">
                ...
                <?php if (!empty($perbaikan)) : ?>
                    <?php foreach ($perbaikan as $item) : ?>
                        <tr>
                            ...
                            <td><?= $item['dibuat']; ?></td>
                            <td>
                                <a href="fungsi/accepted.php?id_perbaikan=<?= $item['id_perbaikan']; ?>" class="btn btn-success">Accept</a>
                                <a href="fungsi/rejected.php?id_perbaikan=<?= $item['id_perbaikan']; ?>" class="btn btn-danger">Reject</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php else : ?>
                    <tr>
                        <td colspan="6" class="text-center">Tidak ada daftar permohonan.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
